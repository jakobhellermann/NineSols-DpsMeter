...
public class DpsMeterMod : BaseUnityPlugin {
    ...
    private void Awake() {
        ...
        try {
            configResetMode = Config.Bind("General",
                "Reset Mode",
                DpsResetMode.LockToFirstEnemy,
            ...
            configUpdateOnHits = Config.Bind("General",
                "Only update DPS on hits",
                true,
                "When enabled, the DPS value is only calculated on every hit. Otherwise, it will continuously adapt as time goes on.");
            configShowDamageNumbers = Config.Bind("General",
                "Show damage numbers",
                true,
            ...
            configShortcutPause = Config.Bind("Shortcuts",
                "Pause DPS Tracking",
                KeyboardShortcut.Empty,
                "Temporarily disable DPS tracking");
            configShortcutReset = Config.Bind("Shortcuts",
                "Reset DPS Tracking",
                KeyboardShortcut.Empty,
